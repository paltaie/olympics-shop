<%@include file="include/include.jsp"%>
		...
		<div id="content">
			...
			<a id="place_order" class="button" href="oly?action=checkout&confirmed=true">Place order</a>
			<a class="button" href="oly?action=checkout">Re-enter information</a>
		</div>
		<%@include file="include/footer.html"%>
		<script type="text/javascript">
			$(document).ready(function() {
				$.get("async?type=cartTable", function(data) {
