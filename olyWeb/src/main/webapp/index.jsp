<%@include file="WEB-INF/jsp/include/include.jsp"%>
		...
		<div id="content">
			<h2>Welcome!</h2>
			<p>Welcome to what is probably the best ever Olympics shop you've ever encountered in your entire life. Head over to the <a href="<c:url value="/products"/>">All products</a> page in order to start your foray into the best shopping experience of your entire life, and arguably the best this side of the millennium.</p>
			...
			<p><a id="all_products" href="<c:url value="/products"/>">All products</a></p>
		</div>
		<div id="aside">
