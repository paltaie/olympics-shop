package com.wsp.olympics.supplierapp.util;
...
public class WsseAuthHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public boolean handleMessage(SOAPMessageContext smc) {
		boolean outbound = (Boolean) smc.get(SOAPMessageContext.MESSAGE_OUTBOUND_PROPERTY);
		if (outbound) {
			try {
				...
				SOAPHeader sh = envelope.getHeader() == null ? envelope.addHeader() : envelope.getHeader();
